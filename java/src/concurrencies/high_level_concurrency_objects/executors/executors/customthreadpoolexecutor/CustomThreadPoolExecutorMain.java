 ...
 *
 */
public class CustomThreadPoolExecutorMain {

	public static void main(String args[]) throws InterruptedException {

		new CustomThreadPoolExecutorMain().runnableAnonymousClassLambdaExpression();

		new CustomThreadPoolExecutorMain().newCachedThreadPoolExecutorService();

		new CustomThreadPoolExecutorMain().newFixedThreadPoolExecutorService();

		new CustomThreadPoolExecutorMain().defaultThreadFactoryThreadPoolExecutor();

		// call newSingleThreadExecutor() at the end
		new CustomThreadPoolExecutorMain().newSingleThreadExecutorExecutorService();
	}
	...
	void defaultThreadFactoryThreadPoolExecutor() throws InterruptedException {
		...
		// Create ThreadPoolExecutor(corePoolSize, maximumPoolSize,
		// keepAliveTime, unit, workQueue) & two optional parameters
		...
		Java_9345_CustomThreadPoolExecutor customExecutorPoolThread = new Java_9345_CustomThreadPoolExecutor(
				executorPoolThread, 3);

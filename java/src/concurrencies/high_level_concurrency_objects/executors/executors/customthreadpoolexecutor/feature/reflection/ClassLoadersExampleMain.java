...
//class loaders in conjunction with reflection
public class ClassLoadersExampleMain {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		// loader, in this case, the system default one, using the loadClass() method
		...
		// it is possible to do it also using class for name and passing the class loader as parameter

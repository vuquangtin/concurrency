...
//collections and reflections, arrays
public class ReflectionCollectionsMain {
	...
	// extracts all elements of a collection if the passed ref is a collection
	...
	private static void reflectionArrays() throws ClassNotFoundException {
		...
		// there are other ways to load arrays: retrieve the class from an instance
		...
		System.out.println("stringArrayClassUsingClassForName is array: " + stringArrayClassUsingClassForName.isArray());

		// this has no much sense in my opinion since we are creating an array
		// at runtime and getting the class to create a new one...

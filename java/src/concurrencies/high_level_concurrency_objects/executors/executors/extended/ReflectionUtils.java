...
public class ReflectionUtils {
	...
	public static Method getMethod(Class<?> clazz, String methodName,
			Class<?> returnType, Class<?>... inputParams) {
	...
	public static boolean setSetterMethod(Object target, String methodName,
			String value) throws IllegalArgumentException,
			IllegalAccessException, InvocationTargetException,
			MethodNotFoundException {// , UnableToFindSuitablePopulatorException
										// {
		...
		// if (method == null) {
		//
		// throw new MethodNotFoundException("Unable to find setter method "
		// + methodName + " with correct signature");
		// }
		//
		// if (value == null ||
		...
		// }
		//
		// BeanStringPopulator<?> populator = BeanStringPopulatorRegistery
		// .getBeanStringPopulator(method.getParameterTypes()[0]);
		//
		// if (populator == null) {
		//
		// throw new UnableToFindSuitablePopulatorException(
		// "Unable to find BeanStringPopulator for "

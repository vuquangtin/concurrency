...
public class ThreadPoolInfo implements Serializable, Cloneable {
	...
	public String toString() {
		StringBuilder buffer = new StringBuilder(160).append("ThreadPoolInfo [name=").append(name).append(", coreSize=")
				.append(coreSize).append(", maxSize=").append(maxSize).append(", threadKeepAliveTime=")
				.append(threadKeepAliveTime).append(", queueSize=").append(queueSize).append("]");

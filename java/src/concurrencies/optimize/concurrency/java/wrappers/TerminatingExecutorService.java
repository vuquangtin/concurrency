 ...
 *
 */
public class TerminatingExecutorService extends DelegatingExecutorService
		implements AutoCloseable {
	static Logger logger = Logger.getLogger(TerminatingExecutorService.class
			.getName());

	private final int timeout;
	private final TimeUnit units;

	public TerminatingExecutorService(ExecutorService service, int timeout,
			TimeUnit units) {
		super(service);

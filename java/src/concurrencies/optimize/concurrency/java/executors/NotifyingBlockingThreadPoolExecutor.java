...
public class NotifyingBlockingThreadPoolExecutor extends ThreadPoolExecutor {
	...
	public NotifyingBlockingThreadPoolExecutor(int poolSize, int queueSize, long keepAliveTime,
		...
		super(poolSize, // Core size
				poolSize, // Max size
				keepAliveTime, keepAliveTimeUnit, new ArrayBlockingQueue<Runnable>(Math.max(poolSize, queueSize)),
	...
	public NotifyingBlockingThreadPoolExecutor(int poolSize, int queueSize, long keepAliveTime, TimeUnit unit) {
		...
		super(poolSize, // Core size
				poolSize, // Max size
				keepAliveTime, unit, new ArrayBlockingQueue<Runnable>(Math.max(poolSize, queueSize)),
				// not smaller than the poolSize (to avoid redundant threads)

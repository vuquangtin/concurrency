 ...
 * specific method which can be consumer facing. This is what should be
...
public class ObservableUtil {
	 ...
	 */
	public List<QuoteResource> processListOfQuotes(int cnt,
			boolean isIntroduceDelay) {
		long start = System.currentTimeMillis();
		System.out.println("1. creating callable task list");
		List<Callable<QuoteResource>> f = TaskUtility.getListQuoteCallable(
				isIntroduceDelay, cnt);

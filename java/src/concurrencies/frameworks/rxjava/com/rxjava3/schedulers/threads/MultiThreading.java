...
public class MultiThreading {
	...
	public void runsObservableOnADifferentThread() throws Exception {
		Observable.fromCallable(thatReturnsNumberOne())
				.subscribeOn(Schedulers.newThread()).map(numberToString())
				.subscribe(printResult());
	...
	public void runsSubscriberOnADifferentThread() throws Exception {
		TestSubscriber<String> testSubscriber = TestSubscriber.create(Observers
				.create(printResult()));
	...
	public void runsOperatorOnADifferentThread() throws Exception {
		...
		Observable.fromCallable(thatReturnsNumberOne())
				.observeOn(Schedulers.newThread()).map(numberToString())
	...
	@Test
	public void runsObservableOperatorAndSubscriberOnDifferentThreads()
			throws Exception {
		TestSubscriber<String> testSubscriber = TestSubscriber.create(Observers
				.create(printResult()));

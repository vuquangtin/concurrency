...
public class CrawlerServiceDTO<T> implements Serializable {
	...
	private static final DateTimeFormatter formatter = DateTimeFormatter
			.ofPattern("dd-MMM-uuuu HH:mm:ss:SSS")
	 ...
	 *
	 * @param responseSentTime
	 *            the new response sent time
	 */
	 ...
	 *
	 * @param errorMessagesToBeAdded
	 *            the error messages
	 */
	public void addErrorMessages(
			List<? extends ErrorMessage> errorMessagesToBeAdded) {
	...
	public void addTraceInfo(Span span) {
		if (null != span) {
			String hexTraceId = span.context().getTraceIdString();
			long spanId = span.context().getSpanId();
	...
	public String toString() {
		return "BaseServiceDTO [entityStatus=" + serviceStatus
				+ ", errorMessages=" + errorMessages + ", data=" + data
				+ ", requestRecievedTime=" + requestReceivedTime
				+ ", responseSentTime=" + responseSentTime + ", pageSize="
				+ pageSize + ", pageFrom=" + pageFrom + ", pageTo=" + pageTo
				+ "]";
	}

...
public class TerminateTaskUsingFuture {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		SumFirstNumbersUsingFuture sumTask = new SumFirstNumbersUsingFuture(500000);
...
class SumFirstNumbersUsingFuture implements Callable<Integer> {
	private int n;
	
	public SumFirstNumbersUsingFuture(int n) {
		this.n = n;
	}

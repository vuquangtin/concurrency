...
public class TerminateAllTasksInExecutorService {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		executorService.submit(new SumFirstNumbersAllTasks(400000));
		executorService.submit(new SumFirstNumbersAllTasks(300000));
		executorService.submit(new SumFirstNumbersAllTasks(200000));
		executorService.submit(new SumFirstNumbersAllTasks(100000));
		executorService.submit(new SumFirstNumbersAllTasks(100000));
		executorService.submit(new SumFirstNumbersAllTasks(100000));
		executorService.submit(new SumFirstNumbersAllTasks(100000));
		executorService.submit(new SumFirstNumbersAllTasks(100000));
...
class SumFirstNumbersAllTasks implements Callable<Integer> {
	private int n;

	public SumFirstNumbersAllTasks(int n) {
		this.n = n;
	}

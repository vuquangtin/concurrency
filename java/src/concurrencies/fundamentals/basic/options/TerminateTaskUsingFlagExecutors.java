...
public class TerminateTaskUsingFlagExecutors {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		SumFirstNumbersUsingFlag sumTask = new SumFirstNumbersUsingFlag(50);
...
class SumFirstNumbersUsingFlag implements Callable<Integer> {
	private int n;
	private volatile boolean cancelTask;
	
	
	public SumFirstNumbersUsingFlag(int n) {
		this.n = n;

...
public class TerminateBlockedTaskUsingThreadAPIExecutor {
	public static void main(String[] args) throws InterruptedException {

		System.out.println("Thread main started");

		ExecutorService executorService = Executors.newCachedThreadPool();
		Future<?> result = executorService.submit(new TerminateBlockedExecutorTask());
...
class TerminateBlockedExecutorTask implements Runnable {
	public void run() {

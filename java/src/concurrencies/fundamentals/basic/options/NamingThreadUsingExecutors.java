...
public class NamingThreadUsingExecutors {
	...
	public static void main(String[] args) throws InterruptedException, ExecutionException {
		...
		List<Future<Integer>> returnedValues = executorService.invokeAll(Arrays.asList(
				new NamingThreadSumFirstNumbers(50), 
				new NamingThreadSumFirstNumbers(40),
				new NamingThreadSumFirstNumbers(30),
				new NamingThreadSumFirstNumbers(20),
				new NamingThreadSumFirstNumbers(10)));
...
class NamingThreadSumFirstNumbers implements Callable<Integer> {
	private int n;
	
	
	public NamingThreadSumFirstNumbers(int n) {
		this.n = n;
	}

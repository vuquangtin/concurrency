...
public class WatingForThreadsToFinishUsingJoin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread thread1 = new Thread(new WatingForThreadsToFinishTask(100l));	
		Thread thread2 = new Thread(new WatingForThreadsToFinishTask(200l));
		Thread thread3 = new Thread(new WatingForThreadsToFinishTask(300l));
		Thread thread4 = new Thread(new WatingForThreadsToFinishTask(50l));	
...
class  WatingForThreadsToFinishTask implements Runnable {
	private long sleep;
	
	public WatingForThreadsToFinishTask(long sleep) {
		this.sleep = sleep;
	}

...
public class ShutdownHookTest {
	...
	static public void main(String args[]) throws Throwable {
		...
		Runtime.getRuntime().addShutdownHook(new ShutdownHookTest_Hook(500, 1));
		...
		/*
		 * ... start another thread that will do another exit. (Need to make
		 * sure the hooks aren't run twice on exit)
		 */
		new Thread() {
			public void run() {
				try {
		...
		/*
		 * Finally, just wait to make sure that the exit actually happens and
